...
export interface View<COMPONENT, NATIVE_ELEMENT = any> {
  ...
  ): SimpleComponentView<COMPONENT, NATIVE_ELEMENT>;
...
export class SimpleComponentView<COMPONENT, NATIVE_ELEMENT = Element>
  implements View<COMPONENT, NATIVE_ELEMENT> {
  ...
  getRouterLinks(
    predicateFunction: (type: Type<any>) => Predicate<DebugElement>
  ): DebugElement[] {
